...
rel_length = extra_joint.params.domain_length / extra_joint_ref.params.domain_length;
heatmap_growth_vary_length(extra_joint,normalization, 5, "wavelength.svg", 1,0.7*colAxis, 0, cMap,rel_length)

rel_length = faster_growth.params.domain_length / extra_joint_ref.params.domain_length;
heatmap_growth_vary_length(faster_growth,normalization, 5, "faster_growth.svg", 1,1.2*colAxis, 0, cMap,rel_length)
